...
Working checklist for the Fall 2025 officer team of ACM @ RCC. Folder: `semesters/2025-fall/`. The rules behind this checklist are in [semester-lifecycle.md](../../docs/01-governance/semester-lifecycle.md).
...
This folder was created in August 2026, after the semester ended. It was built from the Cal Hacks 12.0 trip budget, the Spring 2026 ASRCC funding request, and the public ICPC Southern California Regional pages. Nobody ran the checklist below at the time, so the boxes stay unticked unless a record shows the step happened. Every `[TBD]` in this folder is a real gap: fill it from the advisor's files, the treasurer's records, or Discord history, and say where the number came from.

What is known for sure: the club sent a group to Cal Hacks 12.0 (October 24 to 26, 2025, San Francisco; 11 members accepted) and RCC hosted a site for the ICPC Southern California Regional Contest on November 15, 2025. Details: [events/](events/README.md).
...
- [ ] Confirm the weekly slot (Thursdays, 12:50 to 1:50 PM, BLCIS A-210) and ask the advisor to book the room. See [room-booking.md](../../docs/02-operations/room-booking.md).
...
- [ ] After the meeting: `scripts/new-meeting.sh 2025-fall YYYY-MM-DD`, fill in attendance count, decisions, action items, commit within 48 hours.
...
- [ ] Event gets a yes: `scripts/new-event.sh 2025-fall YYYY-MM-DD slug`, fill `plan.md`, confirm the calendar row the script added. Walk through [event-checklist.md](../../docs/02-operations/event-checklist.md).
...
- [ ] Open one PR titled `close 2025-fall`. Outgoing team opens it, incoming team reviews and merges. See [handoff-procedure.md](../../docs/01-governance/handoff-procedure.md).

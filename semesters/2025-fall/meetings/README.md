...
```sh
scripts/new-meeting.sh 2025-fall YYYY-MM-DD
```
...
Backfilled in August 2026. No meeting notes were kept in this repo for Fall 2025. If notes exist elsewhere (Discord, a shared drive), add one file per meeting with the count and decisions, and leave names out. Meetings held: [TBD].

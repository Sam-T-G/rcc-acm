...
Every dated thing this semester, in one table. Deadlines that repeat every year are pre-seeded with `[TBD]` dates. Replace the date when you know it, mark the status `n/a` if the row does not apply this term, and add rows for anything else with a date.

`scripts/new-event.sh` appends a row here for each new event folder. Keep the comment line under the table.

Types: `deadline`, `meeting`, `event`, `training`, `milestone`, `break`. Status: `planned`, `submitted`, `done`, `n/a`.

Academic dates are from the RCCD 2026-2027 academic calendar and the RCC dates-and-deadlines page (checked 2026-08-24). The term runs August 24 to December 18, 2026. Meetings are Thursdays; the first Thursday of the term is August 27 and the last Thursday before finals is December 10.

## Table

| Date | Event | Type | Owner (role) | Status |
|---|---|---|---|---|
| 2026-08-24 | First day of classes | milestone | President | done |
| 2026-08-27 | First weekly meeting (Thursdays, 12:50 to 1:50 PM, BLCIS A-210); first Thursday of the term, confirm the room is booked | meeting | President | planned |
...
| [TBD] | Cal Hacks 13.0 go/no-go decision (event is Fall 2026 in San Francisco; date [TBD]; applications usually close 3 to 4 weeks out) | milestone | Chair, Trip lead | planned |
| [TBD] | Cal Hacks 13.0 (create the event folder with `scripts/new-event.sh` once the date is known) | event | Trip lead | planned |
...
| n/a | Advisor training and ICC budget training (early March; spring only) | training | Advisor, ICC Representative | n/a |
| n/a | ASRCC funding request due to <studentactivities@rcc.edu> (late April; spring only) | deadline | Treasurer | n/a |
| n/a | ASRCC funding hearing, 15-minute Q&A (mid May; spring only) | meeting | President, Treasurer | n/a |
| n/a | ASRCC allocation notice (by July 1); the FY 2026-27 notice was due 2026-07-01 and its content is [TBD] | milestone | Treasurer | n/a |
<!-- new-event.sh inserts rows above this line. Keep this comment. -->

## Look ahead

- Winter 2027 session: January 4 to February 11, 2027. The club has no winter folder; decide in the decision log if one is needed.
- Spring 2027: classes begin February 16, 2027; spring break April 12 to 18; finals June 4 to 11; term ends June 11. The FY 2027-28 ASRCC packet comes out in early February 2027 and is due in late April 2027.

## Where the recurring dates come from

- ASRCC funding cycle (fiscal year July 1 to June 30; packet in early February; requests due late April; hearings mid May; allocation notice by July 1): [asrcc-funding.md](../../docs/02-operations/asrcc-funding.md).
- Club renewal, ICC meetings, and good standing: [club-recognition-and-icc.md](../../docs/02-operations/club-recognition-and-icc.md).
- Academic calendar (first day, holidays, finals): the RCC academic calendar page at <https://www.rcc.edu/academics/academic-calendar.html>, the RCCD 2026-2027 calendar PDF at <https://www.rccd.edu/admin/ed_services/documents/academic_calendars/2026_2027_Academic_Calendar.pdf>, and <https://www.rcc.edu/academics/dates-and-deadlines.html>.
- Elections: [elections.md](../../docs/00-charter/elections.md).
- ICPC Southern California Regional: <https://scl.na.icpc.global/> and [icpc-regional-site.md](../../docs/03-playbooks/icpc-regional-site.md).
- Cal Hacks: <https://www.calhacks.io/> and [hackathon-trip.md](../../docs/03-playbooks/hackathon-trip.md).
- ACM chapter annual report: <https://www.acm.org/chapters/chapter-policies>.

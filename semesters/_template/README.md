...
Working checklist for the SEMESTER_LABEL officer team of ACM @ RCC. Folder: `semesters/SEMESTER_SLUG/`. The rules behind this checklist are in [semester-lifecycle.md](../../docs/01-governance/semester-lifecycle.md).

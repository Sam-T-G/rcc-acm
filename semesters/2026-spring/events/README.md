...
None yet. This folder was backfilled in August 2026 and no event records for Spring 2026 were available. Events that may have run and would each need a folder if records exist:

| Event | What is known | Folder |
|---|---|---|
| ICPC preparation or other Compete events | [TBD] | none |
| ACM AI Hackathon | brand assets exist in `assets/` (banner, icon, QR); date and term [TBD] | none; see the [playbook](../../../docs/03-playbooks/acm-ai-hackathon.md) |
| Workshops or guest speakers | [TBD] | none |
